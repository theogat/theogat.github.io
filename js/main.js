$(document).ready(function(){
  ...
  $('#software').click(function(){
    ...
    if (language == 'us') {
      ...
      $('p').html('Ένα απλό πρόγραμμα, που σας θυμίζει τα γενέθλια των φίλων σας, με την βοήθεια μιας βάσης δεδομένων SQLite3.  Το πρόγραμμα συνοδεύεται κι από έναν επεξεργαστή της SQLite3 βάσης (Birthday Editor).')      
    }
  ...
  $('#el_flag').click(function(){
    language = 'el';
    document.getElementById('name').innerHTML = 'Θεόδωρος <span class="logo_bold">Γάτσιος</span>';

class Level2 extends Phaser.Scene {
	constructor(){
		super({ key: 'Level2' })
    this.heights = [5, 4, null, 4, 6, 4, null, 8, 8];
	}

	preload() {
    this.load.image('platform2', 'platforms/greenBook.png');
    ...
    this.load.image('bg4', 'scenes/cities/city2.png');
    console.log('running');
    this.load.image('bg5', 'scenes/buildings/juniorHighSchool.png');
    ...
    gameState.bg1 = this.add.image(0, -20, 'bg4');
    gameState.bg2 = this.add.image(0, 20, 'bg5');
